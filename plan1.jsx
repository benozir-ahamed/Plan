...
<head>
    ...
    <title>IntelliMail Campaign Dashboard</title>
    <!-- Tailwind CSS CDN -->
    <script src="https://cdn.tailwindcss.com"></script>
    <!-- React & Babel CDNs to run JSX in the browser -->
    ...
    <style>
        /* General Styles for Inter Font */
        body {
            font-family: 'Inter', sans-serif;
        }
        /* Hide the navigation buttons on the first and last step */
        [disabled] {
...
<body class="antialiased">
    ...
    <script type="text/babel">
        // Lucide icons are imported globally by the CDN, but we define them here for clarity in JSX
        const { Upload, Split, Sparkles, Send, ArrowLeft, ArrowRight } = lucide;
